...
export function DesignsPage({ onBack, cart, setCart, isCartOpen, setIsCartOpen, notice, isNoticeVisible, showNotice, totalItems, formattedSubtotal, updateQuantity }: DesignsPageProps) {
